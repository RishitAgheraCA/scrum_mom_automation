"""
Django settings for scrum_mom_automation project.
...
SECRET_KEY = 'django-insecure--pzmqp((8j(yt+qojajagkvrvz1ne-iu5fw(s7hop3nmvbfa@-'
...
ROOT_URLCONF = 'scrum_mom_automation.urls'
...
WSGI_APPLICATION = 'scrum_mom_automation.wsgi.application'
