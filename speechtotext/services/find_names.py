...
def assign_speaker_name(dialogue):
    ...
    for i in range(0, len(lines), 2):
        ...
        print('dialog lineeeeeeeeeeeeeeeee',dialogue_line)
        ...
        # Append the dialogue line with the speaker's name to the result string
        result += f"{speaker_name} {speaker_number} {speaker_line.split()[2]}\n"
        result += f"{dialogue_line}\n"
